...
class AccompanimentMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        val action = AccompanimentMenuFragmentDirections.actionAccompanimentMenuFragment2ToCheckoutFragment()
    ...
    fun cancelOrder() {
        ...
        val action = AccompanimentMenuFragmentDirections.actionAccompanimentMenuFragment2ToStartOrderFragment()
        this.findNavController().navigate(action)
    }
